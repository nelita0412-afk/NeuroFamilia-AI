    ...
    >
      ...
      <header className="relative z-10 mx-auto flex w-full max-w-6xl items-center justify-between px-5 pt-6 sm:px-8">
        <Link href="/" className="flex items-center gap-3" aria-label="NeuroFamilia Galápagos">
          ...
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-[#F8FBFF]/80">NeuroFamilia Galápagos</p>
            <p className="text-sm font-semibold text-[#F8FBFF]">Universo de crecimiento humano</p>
          </div>
        </Link>
        <Link
          href="/login"
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-1 flex-col items-center justify-center px-5 pb-44 pt-10 text-center sm:px-8">
        <div className="js-hero-turtle-wrap relative">
          <div
            className="absolute left-1/2 top-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#29C7D8]/25 blur-3xl"
            aria-hidden="true"
          />
          <Image
            src="/images/logo/logo.png"
            alt="Tortuga NeuroFamilia"
            width={440}
            height={378}
            priority
            className="js-hero-turtle relative drop-shadow-[0_24px_48px_rgba(2,32,76,0.55)]"
          />
        </div>

        <div className="js-hero-content mt-6">
          <p className="js-hero-kicker text-xs font-bold uppercase tracking-[0.3em] text-[#29C7D8]">
            Un ecosistema de crecimiento humano
          </p>
          <h1 className="js-hero-title mt-4 text-4xl font-extrabold leading-[1.1] text-[#F8FBFF] sm:text-6xl">
          ...
          <p className="js-hero-subtitle mx-auto mt-5 max-w-xl text-base leading-7 text-[#F8FBFF]/85 sm:text-lg">
            Ciencia y cuidado integral para tu vida y tu familia.
            <br />
